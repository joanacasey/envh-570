...
## Objective
The goal of this lab is to get you acquainted with the online RStudio environment on the SPH server and to introduce you to basic commands to explore data. We'll be using fetal death data in R and will examine, manipulate, and plot/map the data in order to better understand what it contains. The final part of this lab will walk you through a series of optional steps to create cartograms and run a simple regression model. 
