...
# Updated 2024-03-28 by Joan Casey
...
# Our first EJ analysis will focus on the association between percent American
# Indian population and oil and gas well counts in Tulsa and Osage counties.
  # 1. Mapping: First we will map our component datasets in order to better understand them
  # 2. Modeling: Next, we will run a Poisson regression model to assess the association 
  # between percent American Indian population and well counts controlling for 
  # population density
  # 3. Diagnostics: Finally, we will assess our model diagnostics, including maping the residuals
  # of our model to assess spatial autocorrelation and using Moran's I to test for 
  # global clustering of residuals
  # 4. Model rerun: We will rerun our model with a spline on census tract centroid lat/long
...
exp_coef <- exp(coef) # 1.07 <- how to interpret this value? Discuss.
...
####
# 4. Model rerun
# Let's rerun our model with a spline on census tract centroid lat/long
# and see how it changes things
...
# Our second EJ analysis will focus on the association between HOLC grades
# and oil and gas well counts in Tulsa and Osage counties.
  # 1. Cleaning: First we will clean the HOLC data
